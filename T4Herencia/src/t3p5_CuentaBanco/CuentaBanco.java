...
public class CuentaBanco {
	...
	/**
	 * true = la cuenta esta bloqueada
	 * false = la cuenta esta desbloqueada
	 */
	public boolean bloqueada;
	
	/**
	 * numeroMaximoCuentas = Si se ha llegado al tope de cuentas, aumentar esta propiedad de la clase
	 */
	public static final int numeroMaximoCuentas=1000;
	
	/**
	 * @param numeroActualCuenta = El numero en el que empieza las cuentas
	 */
	...
	/**
	 * Constructor que crea el objeto con el numero de cuenta y el titular introducidos manualmente
	 * @param numCuenta = Numero de cuenta introducida manualmente
	 * @param titularCuenta = El nombre del titular de la cuenta
	 * bloqueada = Las cuentas estan desbloqueadas al crearse
	 * saldo = Las cuentas empiezan con $0 de saldo
	 */
	...
	/**
	 * Este constructor genera el numero de la cuenta de forma automatica, solo se necesita introducir el nombre para el titular de la cuenta
	 * @param titularCuenta = El nombre del titular de la cuenta
	 * bloqueada = Las cuentas estan desbloqueadas al crearse
	 * saldo = Las cuentas empiezan con $0 de saldo
	 */
	...
	/**
	 * Resta dinero de this.saldo, en caso de que no este bloqueada, y tengas suficiente saldo para retirar esa cantidad
	...
	/**
	 * Reemplaza el nombre del titular actual de la cuenta por uno nuevo, en caso de que no este bloqueada y comprueba que tenga caracteres el nuevo titular
	...
	/**
	 * Desbloquea la cuenta, funciona estando bloqueada
	 */
	void desbloquear() {
		this.bloqueada=false;
