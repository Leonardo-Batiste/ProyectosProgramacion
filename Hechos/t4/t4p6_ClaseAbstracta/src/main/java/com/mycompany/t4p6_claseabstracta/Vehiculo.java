...
public abstract class Vehiculo {
    ...
    public void arrancarMotor() {
        if (numLitrosActual > 0) {
            System.out.println("El vehiculo con matricula " + this.matricula + " ha arrancado");
            motorArrancado = true;

            if (estaEnReserva == true) {
                System.out.println("El vehiculo con matricula " + this.matricula + " esta en reserva de combustible");
            }
        } else if (numLitrosActual <= 0) {
            System.out.println("El vehiculo con matricula " + this.matricula + " no tiene combustible");
        } else if (motorArrancado == true) {
            System.out.println("El vehiculo con matricula " + this.matricula + " ya esta arrancado");
        }
    }
    ...
    public void pararMotor() {
        if (motorArrancado) {
            ...
            System.out.println("El vehiculo con matricula " + this.matricula + " ha parado el motor");
        }
    }
    ...
    public void repostar(double litros) {
        if ((numLitrosActual + litros) > maxLitrosDeposito) {
            ...
            System.out.println("El vehiculo con matricula " + this.matricula + " ha rebosado el deposito");
        } else {
            this.numLitrosActual += litros;
            System.out.println("El vehiculo con matricula " + this.matricula + " tiene " + numLitrosActual + " litros de combustible");
        }
    }
    ...
    public void fijarVelocidad(double velocidad) {
        if (this.motorArrancado == true) {
            if (velocidad > this.velocidadMaxima) {
                ...
                System.out.println("El vehiculo con matricula " + this.matricula + " ha fijado la velocidad a " + this.velocidadActual);
            } else if (velocidad < 0) {
                this.velocidadActual = 0;
                System.out.println("El vehiculo con matricula " + this.matricula + " ha fijado la velocidad a 0");
            } else {
                this.velocidadActual = velocidad;
                System.out.println("El vehiculo con matricula " + this.matricula + "ha fijado la velocidad a " + this.velocidadActual);
            }
        } else {
            System.out.println("El vehiculo con matricula " + this.matricula + " no puede fijar la velocidad, porque no esta arrancado");
        }
    }
    ...
    protected double litrosNecesarios(double distancia) {
